...
<head>
    ...
    <title>How the Expert System Works | GAMEFOWL Documentation</title>
    <meta name="description"
        content="Plain-language documentation of the GAMEFOWL expert system: the knowledge base, the scoring formula, and the health-check flow.">
...
<body>
    ...
    <nav class="toc-mobile" aria-label="Sections">
        <ol>
            <li><a href="#what-it-is" data-toc="what-it-is"><span>1</span>Overview</a></li>
            <li><a href="#knowledge-base" data-toc="knowledge-base"><span>2</span>Knowledge base</a></li>
            <li><a href="#engine" data-toc="engine"><span>3</span>Engine &amp; formula</a></li>
            <li><a href="#flow" data-toc="flow"><span>4</span>Flow</a></li>
            <li><a href="#possible" data-toc="possible"><span>5</span>"Possible," not a diagnosis</a></li>
            <li><a href="#walkthrough" data-toc="walkthrough"><span>6</span>Example</a></li>
            <li><a href="#faq" data-toc="faq"><span>7</span>FAQ</a></li>
        </ol>
    </nav>
    ...
    <div class="container layout">
        ...
        <aside class="toc">
            <nav aria-label="Contents">
                ...
                <ol class="toc-list">
                    <li><a href="#what-it-is" data-toc="what-it-is"><span class="toc-num">1</span>What this system is</a></li>
                    <li><a href="#knowledge-base" data-toc="knowledge-base"><span class="toc-num">2</span>The knowledge base</a></li>
                    <li><a href="#engine" data-toc="engine"><span class="toc-num">3</span>The diagnostic engine &amp; formula</a></li>
                    <li><a href="#flow" data-toc="flow"><span class="toc-num">4</span>The end-to-end flow</a></li>
                    <li><a href="#possible" data-toc="possible"><span class="toc-num">5</span>Why "possible," not a diagnosis</a></li>
                    <li><a href="#walkthrough" data-toc="walkthrough"><span class="toc-num">6</span>Example walkthrough</a></li>
                    <li><a href="#faq" data-toc="faq"><span class="toc-num">7</span>Frequently asked questions</a></li>
                </ol>
  ...
  "data": {
    ...
    "created_at": "…"
            ...
            <section id="faq" class="doc-section">
                ...
                <details class="tech">
                    <summary><span aria-hidden="true">🗂️</span> For technical reviewers: where each part lives in the code</summary>
                    <div class="tech-body">
                        <ul class="code-map">
                            <li><span>Starter knowledge base (diseases, symptoms, rules, advice)</span><code>database/seeders/KnowledgeBaseSeeder.php</code></li>
                            <li><span>Diagnostic engine (the formula)</span><code>app/Services/ExpertSystem/DiagnosticEngine.php</code></li>
                            <li><span>Engine settings (20% cut-off, five results)</span><code>config/expertsystem.php</code></li>
                            <li><span>Health-check endpoint (validate, score, save)</span><code>app/Http/Controllers/HealthAssessmentController.php</code></li>
                            <li><span>Engine tests, including the worked examples</span><code>tests/Unit/ExpertSystem/DiagnosticEngineTest.php</code></li>
                        </ul>
                    </div>
                </details>
            </section>

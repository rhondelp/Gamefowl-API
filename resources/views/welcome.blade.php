...
<head>
    ...
    <style>
        * {
        ...
        /* Documentation link under the callout */
        .docs-cta {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
...
<body>
    ...
    <section id="about">
        <div class="wrap">
            ...
            <div class="docs-cta">
                <a class="btn btn-ghost" href="{{ route('docs.gate') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                ...
                <p>
                    The knowledge base, the scoring formula, and the health-check flow, explained in plain language.
                    Password-protected; shared with the project's adviser and panel.
                </p>
            </div>
        </div>
    </section>
